        ...
        holder.id_title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (row_index == position) {
                    ...
                    holder.id_title.setBackground(context.getResources().getDrawable(R.drawable.white_background_btn));
                } else {
                    row_index = position;
                    holder.id_title.setTextColor(context.getResources().getColor(R.color.white));
                    holder.id_title.setBackground(context.getResources().getDrawable(R.drawable.darkgrey_background_btn));
