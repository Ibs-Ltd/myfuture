...
import com.myfutureapp.profile.ui.JobLocationFragment;
import com.myfutureapp.util.Helper;

import java.util.ArrayList;
import java.util.List;

public class LocationCityAdapter extends RecyclerView.Adapter<LocationCityAdapter.ViewHolder> {

    private final Context context;
    private final List<StateResponse> stateResponses;
    private CitySelectedUnselect citySelectedUnselect;

    public LocationCityAdapter(Context context, List<StateResponse> stateResponses) {
...
//                    citySelectedUnselect.cityUnSelected(stateResponses.get(position).name);
                ...
                JobLocationFragment.settingAllIndiaButton();
            }
        });
...
//        this.graduationList.addAll(dataItemList);
    ...
    public interface CitySelectedUnselect {
        ...
        void cityUnSelected(String name);
    }
